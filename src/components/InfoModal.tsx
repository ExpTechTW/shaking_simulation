          ...
          <ScrollArea className="mt-3 h-[52vh] pr-3">
            <TabsContent value="disc" className="mt-0">
              ...
              <Section title="物理模型的限制・注意事項">
                ...
                <li><b>波形處理</b>：加速度記錄的積分（速度・變位）伴隨高通濾波等處理，長周期成分・永久變位無法準確還原。</li>
              </Section>
            </TabsContent>
            <TabsContent value="usage" className="mt-0">
              <Section title="基本流程">
                <li><b>① 準備波形</b>：於「波形檔案」讀取 miniSEED 三分量加速度記錄（本工具以 10000 counts = 1 cm/s² 換算加速度），或按「載入範例波形」使用內建範例。無記錄時亦可用「正弦波加振」指定方向（NS/EW）・周期・最大變位・持續時間生成合成波（兩端 2 周期漸變）。</li>
                <li><b>② 室內空間</b>：以「室內空間」切換一般住家（和室 4.2×4.2m）／辦公室（6.4×5.2m）。家具・小物可逐項勾選配置，並可調整質量與重心高（%）。重心越高越易轉倒。</li>
                <li><b>③ 建物應答（可選）</b>：開啟「於建物樓層加振」後，以多質點剪力型模型的時刻歷應答解析（Newmark-β 法、Rayleigh 阻尼）求得指定樓層的地板應答（絕對加速度・速度・變位）加振。可指定構造種別（S造：T₁=0.03H・h=2% ／ RC造：T₁=0.02H・h=3%，層高 4m）、層數（3〜50）、對象樓層，並顯示相對地表的 PA 放大率。</li>
                <li><b>④ 加振</b>：按「加振開始」執行。可設定播放速度、振幅倍率、NS↔EW 交換、起始時刻跳過。「回到初始配置」可重複重來。</li>
              </Section>
              <Section title="畫面與操作">
                <li><b>3D 視角</b>：拖曳旋轉、滾輪（縮放）縮放。</li>
                <li><b>波形面板</b>（右上「波形」）：加速度・速度・變位三分量波形與播放游標。右上按鈕可切換「全體顯示 ⇄ 播放時刻±15秒的窗顯示」。縱軸固定為全記錄最大值，可跨窗比較。</li>
                <li><b>變位軌跡</b>（右上「軌跡 NS-EW」）：水平面內的變位軌跡。顯示全軌跡（淡色）、近 2 秒（橙）、目前位置（白點）。</li>
                <li><b>加速度 HUD</b>（畫面上方）：近 1 秒間的最大合成加速度（gal），反映振幅倍率。</li>
                <li><b>狀態面板</b>：顯示各家具的傾斜・移動量・轉倒/移動判定、吊掛物擺角。</li>
              </Section>
              <Section title="觀察提示">
                <li>背高且重心高的家具（書架・文件櫃）在短周期強烈搖晃時易轉倒。</li>
                <li>附滾輪的影印機・辦公椅摩擦小，即使弱搖晃也會大幅移動。</li>
                <li>給予長周期（2〜6秒）大變位的正弦波、或高樓層地板應答時，可觀察超高層在長周期地震動下「緩慢而大」的搖晃與家具滑動。</li>
            ...
            <TabsContent value="faq" className="mt-0">
              <Section title="常見問題">
                ...
                <li><b>Q. 「轉倒」「移動」如何判定？</b><br />A. 相對垂直軸的傾斜超過 45° 判為轉倒，相對初始位置的水平移動超過 5cm 判為移動（一旦判定即保持）。</li>
                ...
                <li><b>Q. 為何越高樓層搖晃越大？</b><br />A. 接近建物固有周期的成分會共振放大。長周期地震動時，超高層的上層變位可達地表數倍；短周期成分於上層則未必放大。</li>
